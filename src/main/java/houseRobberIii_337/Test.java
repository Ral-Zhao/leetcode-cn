...
public class Test {
    public static void main(String[] args) {
        ...
        TreeNode root = TreeUtil.buildTree(3, 2, 3, null, 3, null, 1);
        Assert.assertEquals(7, solution.rob(root));
        solution = new Solution();
        root = TreeUtil.buildTree(3, 4, 5, 1, 3, null, 1);
        Assert.assertEquals(9, solution.rob(root));
        solution = new Solution();
        root = TreeUtil.buildTree(4, 1, null, 2, null, 3);
        Assert.assertEquals(7, solution.rob(root));
        solution = new Solution();
        root = TreeUtil.buildTree(2, 1, 3, null, 4);
        Assert.assertEquals(7, solution.rob(root));
        solution = new Solution();
        ...
        Assert.assertEquals(3038, solution.rob(root));
    }
}
